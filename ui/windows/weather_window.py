...
class WeatherWindow(ctk.CTkToplevel):
    ...
    def _create_ui(self):
        ...
        search_frame = ctk.CTkFrame(inner, fg_color=COLORS['bg_dark'], corner_radius=8)
        ...
        # ── Barra de favoritos ────────────────────────────────────────────────
        fav_frame = ctk.CTkFrame(inner, fg_color=COLORS['bg_dark'], corner_radius=8)
        ...
        self._current_frame = ctk.CTkFrame(inner, fg_color=COLORS['bg_dark'], corner_radius=8)
        ...
        view_row = ctk.CTkFrame(inner, fg_color="transparent")
        ...
        forecast_outer = ctk.CTkFrame(inner, fg_color=COLORS['bg_dark'], corner_radius=8)
