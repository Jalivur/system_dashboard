...
# Variables de entorno desde .env (credenciales Homebridge, Telegram, Pi-hole)
python-dotenv>=1.0.0
...
#   - arp-scan:       Escáner de red local (Red Local — v3.2)
#
# Sudoers para arp-scan (necesario para ejecutar sin contraseña):
